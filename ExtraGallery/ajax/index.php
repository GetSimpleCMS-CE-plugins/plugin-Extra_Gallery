...
if ( !in_array($_GET['mode'], ['gallery-delete', 'gallery-validate-name', 'image-crop', 'thumb-admin', 'thumb-create']) )
	die('unknown mode');
...
switch($_GET['mode']){
	...
	case 'gallery-delete':{ //delete gallery
		...
		//is it locked for 
		if (in_array($name, $settings['delete-lock'])){
			echo json_encode(0);
			break;
		}
